...
// Fetch recent announcements for all departments
try {
    $stmt = $pdo->prepare("
...
<div class="container mt-5">
    ...
    <div class="mt-4">
        <a href="view_student.php" class="btn btn-primary">View Students</a>
        <a href="view_staff.php" class="btn btn-primary">View Staff</a>
        <a href="add_student.php" class="btn btn-secondary">Add Student</a>
        <a href="add_staff.php" class="btn btn-secondary">Add Staff</a>
    </div>

    <!-- Post New Announcement Button -->
    <div class="mt-4">
        <a href="post_announcement.php" class="btn btn-success">Post New Announcement</a>
    </div>
