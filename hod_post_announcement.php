...
// Start session and check if user is logged in as HOD
session_start();
...
<div class="container">
    ...
    <a href="hod_dashboard.php" class="btn btn-secondary mb-4">Back to Dashboard</a>
    ...
    <form action="hod_post_announcement.php" method="POST" enctype="multipart/form-data">
